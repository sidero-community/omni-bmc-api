...
[![GitHub Release](https://img.shields.io/github/v/release/sidero-community/omni-bmc-api)](https://github.com/sidero-community/omni-bmc-api/releases)
[![Go Reference](https://pkg.go.dev/badge/github.com/sidero-community/omni-bmc-api.svg)](https://pkg.go.dev/github.com/sidero-community/omni-bmc-api)
[![go.mod](https://img.shields.io/github/go-mod/go-version/sidero-community/omni-bmc-api)](go.mod)
[![LICENSE](https://img.shields.io/github/license/sidero-community/omni-bmc-api)](LICENSE)
[![Build Status](https://img.shields.io/github/actions/workflow/status/sidero-community/omni-bmc-api/build.yml?branch=main)](https://github.com/sidero-community/omni-bmc-api/actions?query=workflow%3Abuild+branch%3Amain)
[![Go Report Card](https://goreportcard.com/badge/github.com/sidero-community/omni-bmc-api)](https://goreportcard.com/report/github.com/sidero-community/omni-bmc-api)
[![Codecov](https://codecov.io/gh/sidero-community/omni-bmc-api/branch/main/graph/badge.svg)](https://codecov.io/gh/sidero-community/omni-bmc-api)
...
1. Replace all occurrences of `sidero-community/omni-bmc-api` to `your_org/repo_name` in all files.
